    ...
    if (Object.keys(newErrors).length === 0) {
      try {
        ...
        if (response.ok) {
          ...
          if (formData.email_log === "admin@example.com") {
...
//       errors.email_log = "Email is required";
//     } else if (!/\S+@\S+\.\S+/.test(data.email_log)) {
//       errors.email_log = "Invalid email format";
//     }
//     if (!data.password_log) {
//       errors.password_log = "Password is required";
//     } else if (data.password_log.length < 8) {
...
//                   <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-2 order-lg-1">
//                     <img
//                       src="https://img.freepik.com/premium-vector/online-registration-sign-up-with-man-sitting-near-smartphone_268404-95.jpg?semt=ais_hybrid"
//                       className="img-fluid"
//                       alt="Sample"
//                     />
//                   </div>
...
//                             placeholder="Email"
//                             name="email_log"
//                             value={formData.email_log}
//                             onChange={handleChange}
//                           />
//                           {errors.email_log && <span className="error-message">{errors.email_log}</span>}
//                         </div>
//                       </div>
//                       <div className="d-flex flex-row align-items-center mb-4">
//                         <i className="fas fa-lock fa-lg me-4 fa-fw"></i>
...
//                             name="password_log"
//                             value={formData.password_log}
//                             onChange={handleChange}
//                           />
//                           {errors.password_log && <span className="error-message">{errors.password_log}</span>}
//                         </div>
//                       </div>
//                       <div className="d-flex justify-content-left mx-5 mb-3 mb-lg-4">
